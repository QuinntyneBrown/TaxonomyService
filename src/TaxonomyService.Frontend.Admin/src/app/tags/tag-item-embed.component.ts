...
const template = require("./tag-item-embed.component.html");
const styles = require("./tag-item-embed.component.scss");

export class TagItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new TagDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new TagEdit(this.entity));
    }
...
customElements.define(`ce-tag-item-embed`,TagItemEmbedComponent);
