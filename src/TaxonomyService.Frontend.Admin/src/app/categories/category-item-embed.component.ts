...
const template = require("./category-item-embed.component.html");
const styles = require("./category-item-embed.component.scss");

export class CategoryItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new CategoryDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new CategoryEdit(this.entity));
    }
...
customElements.define(`ce-category-item-embed`,CategoryItemEmbedComponent);
